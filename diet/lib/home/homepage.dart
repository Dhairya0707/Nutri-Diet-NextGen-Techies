...
import 'package:diet/demo/design_homepage.dart';
            ...
            child: TextField(
              ...
              onSubmitted: (value) async {
                ...
                try {
                  final content = [
                    Content.text(
                        "Provide a detailed nutritional breakdown of [${_controller.text}] in a tabular format. Include information on serving size, calories, macronutrients (protein, carbohydrates, fat), and key micronutrients (vitamins, minerals).")
                  ];
                  print("");
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => IdeaGenerated(data: data!)));
                  print(response.text);
                } catch (e) {
